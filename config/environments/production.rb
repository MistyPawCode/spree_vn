...
Rails.application.configure do
  Rails.application.routes.default_url_options = { host: "web-production-9e84c.up.railway.app" }
  ...
  config.action_mailer.default_url_options = { host: "web-production-9e84c.up.railway.app" }
